...
const HomeSection: FunctionComponent<HomeSectionType> = ({
  className = "",
}) => {
  return (
    <div
    ...
    >
      <div className="[background:linear-gradient(270deg,_rgba(255,_255,_255,_0),_#fff_65.4%)] flex flex-col items-start justify-start pt-[202px] px-[114px] pb-[220px] box-border gap-[60px] min-w-[961px] max-w-full z-[2] mq450:gap-[15px] mq450:pt-[85px] mq450:px-5 mq450:pb-[93px] mq450:box-border mq900:gap-[30px] mq900:pt-[131px] mq900:px-[57px] mq900:pb-[143px] mq900:box-border mq1350:min-w-full mq1750:flex-1">
      ...
      <div className="h-[788px] relative min-w-[686px] max-w-full mq900:min-w-full mq1750:flex-1">
        <div className="absolute top-[788px] left-[686px] [background:linear-gradient(270deg,_rgba(255,_255,_255,_0),_#fff_65.4%)] w-full h-full [transform:_rotate(180deg)] [transform-origin:0_0] z-[2]" />
        <div className="absolute top-[628px] left-[506px] rounded-341xl bg-dodgerblue-300 w-[100px] h-[100px] z-[3]" />
      </div>
    </div>
  );
};
