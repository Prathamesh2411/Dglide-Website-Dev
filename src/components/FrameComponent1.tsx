...
const FrameComponent1: FunctionComponent<FrameComponent1Type> = ({
  ...
  return (
    <div
      className={`flex-1 flex flex-col items-start justify-start gap-20 min-w-[563px] max-w-full text-left text-45xl text-white font-sf-pro mq450:gap-5 mq900:min-w-full mq1275:gap-10 ${className}`}
    >
      <h1
